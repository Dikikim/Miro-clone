...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-14 z-50 flex items-center justify-end px-4 pointer-events-none">
            <div data-header-panel className={`relative flex items-center gap-3 rounded-2xl px-4 py-2 pointer-events-auto menu-accent-edge ${isDark ? 'glass-panel-dark' : 'glass-panel'}`}>
